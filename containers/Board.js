  ...
  render() {
    return (
      <div className='board-card'>
          ...
          <ul onDrop={this.drop} onDragOver={this.allowDrop} >
            {this.props.tasks && this.props.tasks.map((t,i)=> 
              <div className='item-container' key={i}  draggable={true} onDragStart={this.drag}>
                <li key={i} className={this.props.title === 'done' ? 'done-task' : ''} id={t}>
                  {t}
                </li>
          ...
          {this.props.title !== 'done' && !this.state.inputVisibility &&
          ...
          <style jsx>{`
            ...
            .item-container:hover .remove-task {
              display: block;
            }
          `}</style>
      </div>
